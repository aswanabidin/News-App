...
public class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final ClickListener clickListener){
        ...
        gestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public void onLongPress(MotionEvent e) {
                ...
                if (viewChild != null && clickListener != null) {
                    clickListener.onLongClick(viewChild, recyclerView.getChildPosition(viewChild));
                }
            }
        });
    }
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        ...
        if (viewChild != null && clickListener != null && gestureDetector.onTouchEvent(e)) {
            clickListener.onClick(viewChild, rv.getChildPosition(viewChild));
        }
        return false;
    }
